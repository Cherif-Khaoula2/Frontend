...
export class AttributionTypeComponent implements OnInit, AfterViewInit {
  ...
  columnDefs: ColDef[] = [
    ...
    { headerName: 'Montant Contrat(Jours)', field: 'montantContrat', sortable: true, filter: true, resizable: true },
  ...
  cellRenderer: (params: ICellRendererParams) => {
    ...
    // 🔒 Boutons Modifier/Supprimer seulement si EN_ATTENTE
    if (etat === 'EN_ATTENTE') {
